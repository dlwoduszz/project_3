$(document).ready(function(){
    ...
    $('.menu_btn').click(function(){
        ...
        if($(this).children('p').css('display')=='block'){ 
            $('.side_menu').stop().slideToggle(1000,'swing');
            $('.side_wrap').stop().delay(500).fadeToggle(500,'swing');
            ...
            $('.side_wrap').stop().fadeToggle(500,'swing');
            $('.side_menu').stop().delay(200).slideToggle(1000,'swing');
